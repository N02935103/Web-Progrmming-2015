<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UpdateFoodItemForm.aspx.cs" Inherits="Fitness_Tracker_App_2._0.UpdateFoodItemForm" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h1>Food Item Form <small>Enter information to update the food item</small></h1>
